...
import com.example.demo.starter.module.auth.domain.entity.RefreshToken;
...
public class AuthServiceImpl implements AuthService {
    ...
    public ServiceResponse<AuthResponse> loginWithRefreshToken(String refreshToken) throws BadRequestException {
    ...
    public ServiceResponse<String> register(RegisterDto request) throws BadRequestException {
